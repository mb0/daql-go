...
// Manifest is set of versions sorted by name. A Manifest usually contain exactly one project
// version as first element, due to the project name qualifier prefix.
...
// First returns the first version of the manifest or nil.
...
func (mf Manifest) Diff(old Manifest) map[string]byte {
	...
	if b != nil && a.Vers == b.Vers && a.Name == b.Name {
		return nil
	}
