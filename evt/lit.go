...
func NewMemLedger(b *qry.MemBackend) (*MemLedger, error) {
	...
	return &MemLedger{Bend: b, evs: evs}, nil
}
...
func (l *MemLedger) applyEvent(ev *Event) (func() error, error) {
	...
	case CmdNew:
		...
		err = lit.Apply(l.Bend.Reg, mut, lit.Delta(ev.Arg.Keyed))
		if err != nil {
